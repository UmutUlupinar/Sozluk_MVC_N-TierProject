...
namespace BusinessLayer.ValidationRules
{
    public class CategoryValidator : AbstractValidator<Category>
    {
        public CategoryValidator()
        {
             ...
             RuleFor(a => a.CategoryDescription).MinimumLength(3).WithMessage("en az 3 en fazla 20 karakter olmalı");
             RuleFor(a => a.CategoryDescription).MaximumLength(20).WithMessage("en az 3 en fazla 20 karakter olmalı");
        }
